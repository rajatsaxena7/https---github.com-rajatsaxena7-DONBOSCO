...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/donate',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'donate')
              : const DonateWidget(),
        ),
        FFRoute(
          name: 'campaigndetails',
          path: '/campaigndetails',
          builder: (context, params) => CampaigndetailsWidget(
        ...
        FFRoute(
          name: 'raiseissue',
          path: '/raiseissue',
          builder: (context, params) => const RaiseissueWidget(),
        ),
        FFRoute(
          name: 'mydonations',
          path: '/mydonations',
          builder: (context, params) => const MydonationsWidget(),
        ),
        FFRoute(
          name: 'categories',
          path: '/categories',
        ...
        FFRoute(
          ...
          builder: (context, params) => DonationcompletedWidget(
        ...
        FFRoute(
          name: 'formpage',
          path: '/formpage',
          builder: (context, params) => const FormpageWidget(),
        ),
        FFRoute(
          name: 'paymentprocessingpage',
          path: '/paymentprocessingpage',
          builder: (context, params) => PaymentprocessingpageWidget(
            url: params.getParam(
              'url',
              ParamType.String,
            ),
            campaignref: params.getParam(
              'campaignref',
              ParamType.DocumentReference,
              false,
              ['campaigns'],
